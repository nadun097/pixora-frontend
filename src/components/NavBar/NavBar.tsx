    ...
    return (
        <div className="NavBar">
            ...
            <div className="NavBar-Buttons">
                <div className="marketplace-button inter-bold-white-24px">Marketplace</div>
                <div className="live-auctions-button inter-bold-white-24px">Live Auctions</div>
                <div className="digital-arts-button inter-bold-white-24px">Digital Arts</div>
                <div className="photographs-button inter-bold-white-24px">Photographs</div>
            </div>
            <div className="profile-button">
                <img className="user-icon"
                     ...
                     anima-src="https://cdn.animaapp.com/projects/67ac3ff7b09554a0b38573b8/releases/67ac401ef81239f3d08a9f30/img/user-square-rounded.svg"
